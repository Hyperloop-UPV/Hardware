...
|---|---|---|---|---|---|---|
| EMS, L mínima | 1,92 | 0,76 | 0,88 | 3,52 | 3,52 | **NO CUMPLE** |
| EMS, L máxima | 117,00 | 0,01 | 0,01 | 0,06 | 0,06 | CUMPLE |
| HEMS, L mínima | 6,20 | 0,24 | 0,27 | 1,09 | 1,09 | CUMPLE |
| HEMS, L máxima | 11,20 | 0,13 | 0,15 | 0,60 | 0,60 | CUMPLE |
...
|---|---|---|---|---|---|---|
| EMS, L mínima | 1,92 | 182,3 | 210,9 | 150,8 | 0,33 | 1,7 |
| EMS, L máxima | 117,00 | 3,0 | 3,5 | 2,5 | 20,19 | 106,4 |
| HEMS, L mínima | 6,20 | 56,5 | 65,3 | 46,7 | 1,07 | 5,6 |
| HEMS, L máxima | 11,20 | 31,2 | 36,2 | 25,8 | 1,93 | 10,2 |

| Magnitud | Valor | Unidad | Límite | Resultado | Expresión | Nota |
|---|---|---|---|---|---|---|
| Tensión en la bobina a Ipk | 60,5 | V |  |  | `Rcoil·Ipk` |  |
| Índice de modulación a Ipk con Vbus_min | 0,173 | – |  |  | `V_coil_pk/Vbus_min` |  |
| Corriente máxima alcanzable con Vbus_min (sin pérdidas) (POT-02) | 318,2 | A | 55,0 | CUMPLE | `Vbus_min/Rcoil ≥ Ipk` | Margen de tensión para el lazo de corriente |
...
| Rizado de tensión en el DC-link en el punto Ipk | 1,36 | V |  |  | `Ipk·m(1−m)/(2·fsw·Cdc) + Ipk·ESR_dc` |  |
| Rizado de tensión en el DC-link, peor caso (m = 0,5) (POT-03) | 2,29 | V | 3,50 | CUMPLE | `Ipk/(8·fsw·Cdc) + Ipk·ESR_dc` | Límite: dVdc_pct·Vbus_min |
| Capacidad mínima para el rizado (sin ESR) | 65,5 | µF |  |  | `Ipk/(8·fsw·dVdc_pct·Vbus_min)` |  |
| Frecuencia fundamental de la corriente en el DC-link | 30,0 | kHz |  |  | `2·fsw (unipolar) o fsw (bipolar)` |  |
...
| Energía extrapolada a Ipk | 16,7 | J |  |  | `E_map·(Ipk/I_map)²` | Orientativa (EM-D-03) |
| Cota pesimista con L constante | 40,4 | J |  |  | `½·L_EMS_0·Ipk²` | Doc. v0.2 §6.3: 48 J |
| Capacidad que absorbe la energía | 105,0 | µF |  |  | `Cdc·N_dc_abs` |  |
| Tensión final desde Vbus_min (energía de los mapas) | 664 | V |  |  | `√(Vbus_min² + 2·E_map/C_abs)` | Doc. v0.2: ≈ 650 V |
| Tensión final desde Vbus_max (energía de los mapas) | 694 | V |  |  | `√(Vbus_max² + 2·E_map/C_abs)` | Doc. v0.2: ≈ 690 V |
| Tensión final desde Vbus_max (energía extrapolada a Ipk) | 694 | V |  |  | `√(Vbus_max² + 2·E_ext/C_abs)` |  |
| Tensión final desde Vbus_max (cota pesimista) | 966 | V |  |  | `√(Vbus_max² + 2·E_const/C_abs)` | Doc. v0.2: ≈ 1040 V |
| Tensión de fallo (extrapolada) frente a la tensión continua admisible (POT-04) | 694 | V | 650 | **NO CUMPLE** | `V_fault_max ≤ V_cont` | Sin clamp, chopper ni DC-link mayor |
| Tensión de fallo frente a la tensión nominal del DC-link (POT-05) | 694 | V | 650 | **NO CUMPLE** | `V_fault_max ≤ V_film` |  |
| Tensión de fallo frente a la VDS del MOSFET seleccionado (POT-06) | 694 | V | 900 | CUMPLE | `V_fault_max ≤ VDS` |  |
| Capacidad instalada frente a la necesaria para no superar V_cont desde Vbus_max (POT-07) | 105 | µF | 129 | **NO CUMPLE** | `C_abs ≥ 2·E_ext/(V_cont² − Vbus_max²)` | Doc. v0.2: ≥ 167 µF con 16,7 J |
| Capacidad necesaria con la energía de los mapas (sin extrapolar) | 129 | µF |  |  | `2·E_map/(V_cont² − Vbus_max²)` |  |

### 1.5 Opción clamp o chopper (HW-03)

| Magnitud | Valor | Unidad | Límite | Resultado | Expresión | Nota |
|---|---|---|---|---|---|---|
| Resistencia máxima del chopper | 10,00 | Ω |  |  | `V_chop_on/Ipk` | Para que conduzca Ipk sin superar V_chop_on |
| Potencia de pico en la resistencia | 30,2 | kW |  |  | `V_chop_on·Ipk` |  |
| Energía por evento en la resistencia (cota) | 16,7 | J |  |  | `E_ext` |  |
| Tensión de actuación del chopper por encima de Vbus_max con margen (POT-08) | 550 | V | 446 | CUMPLE | `V_chop_on ≥ k_chop_mrg·Vbus_max` | Para no actuar en servicio |
| Tensión de actuación del chopper por debajo de V_cont (POT-09) | 550 | V | 650 | CUMPLE | `V_chop_on ≤ V_cont` |  |
...
| Número de vías térmicas | 10 | – |  |  | `N_via` | Entrada (TBD) |
| Sección de cobre de una vía | 0,0216 | mm² |  |  | `π/4·(d_via² − (d_via − 2·t_plat)²)` |  |
| Resistencia de una vía | 192,4 | K/W |  |  | `t_pcb/(k_Cu·A_barrel)` |  |
| Resistencia del conjunto de vías | 19,241 | K/W |  |  | `R_via1/N_via` |  |
| Área de FR-4 restante bajo el pad (TER-01) | 79,3 | mm² | 0,0 | CUMPLE | `A_pad − N_via·π·d_via²/4 ≥ 0` | Si es negativa, las vías no caben en el pad |
| Resistencia del FR-4 bajo el pad | 67,3 | K/W |  |  | `t_pcb/(k_FR4·A_FR4)` |  |
| Resistencia de la PCB (vías ∥ FR-4) | 14,961 | K/W |  |  | `1/(1/R_vias + 1/R_fr4)` |  |
...
| Rth cápsula → agua | 16,328 | K/W |  |  | `R_solder + R_pcb + R_TIM + Rth_wb` |  |
| Rigidez dieléctrica del material de interfaz (TER-02) | 4000 | V | 650 | CUMPLE | `V_TIM_bd ≥ V_cont` | Margen exigido por definir con el tipo de aislamiento (HW-04) |

### 3.2 Shunt de corriente

| Magnitud | Valor | Unidad | Límite | Resultado | Expresión | Nota |
|---|---|---|---|---|---|---|
| Potencia en el shunt a Ipk | 1,51 | W |  |  | `Ipk²·R_shunt` |  |
| Energía en el shunt durante el pico | 3,0 | J |  |  | `P_sh_pk·t_pk` | Comparar con la capacidad de pulso del shunt |
| Potencia en el shunt en continuo | 0,050 | W |  |  | `Irms_cont²·R_shunt` |  |
| Potencia de pico en el shunt frente a su potencia nominal (TER-03) | 1,51 | W | 3,00 | CUMPLE | `P_sh_pk ≤ P_sh_rat` | Si el pico es corto, usar la curva de sobrecarga del shunt |
...
| Energía de todas las placas al acumulador durante el pico | 4,0 | kJ | `N_MD·P_board_pk·t_pk` | Dato para ME-C (sin el calor de las bobinas) |
...
| Magnitud | Valor | Unidad | Límite | Resultado | Expresión | Nota |
|---|---|---|---|---|---|---|
| Ancho de pista: Entrada HV (1.ª placa), Ipk (PIS-entrada_pk) | 35,0 | mm | 0,7 | CUMPLE | `ancho previsto ≥ ancho necesario` |  |
| Ancho de pista: Entrada HV (1.ª placa), continuo (PIS-entrada_cont) | 10,0 | mm | 0,0 | CUMPLE | `ancho previsto ≥ ancho necesario` |  |
| Ancho de pista: DC-link ↔ puente, eficaz a Ipk (PIS-puente_rms) | 15,0 | mm | 2,2 | CUMPLE | `ancho previsto ≥ ancho necesario` |  |
| Ancho de pista: Puente → bobina, Ipk (PIS-bobina_pk) | 15,0 | mm | 7,5 | CUMPLE | `ancho previsto ≥ ancho necesario` |  |
| Ancho de pista: Puente → bobina, continuo (PIS-bobina_cont) | 5,0 | mm | 0,7 | CUMPLE | `ancho previsto ≥ ancho necesario` |  |
...
| Vías necesarias para Ipk (cambio de capa de la salida) | 21 | – | `⌈Ipk/I_via⌉` |  |
| Vías necesarias para la entrada de la primera placa | 4 | – | `⌈I_in_first/I_via⌉` |  |
...
|---|---|---|---|---|---|---|---|
| V_cont = 650 V | 0,62 | 3,25 | 16,25 | 1,26 | 1,26 | 1,96 | 1,26 |
| V_fault_max = 694 V | 0,74 | 3,47 | 17,36 | 1,39 | 1,39 | 2,09 | 1,39 |
...
|---|---|---|---|
| V_cont = 650 V | PD1 | 1,87 | 2,40 |
| V_cont = 650 V | PD2 | 3,29 | 4,00 |
| V_fault_max = 694 V | PD1 | 2,03 | 2,40 |
| V_fault_max = 694 V | PD2 | 3,50 | 4,00 |

Distancias requeridas a V_cont = 650 V: el máximo entre la regla del proyecto y las normas aplicables.

| Caso | Regla del proyecto (mm) | IPC-2221B (mm) | IEC 60664-1 (mm) | Requerido (mm) | Criterio |
|---|---|---|---|---|---|
| HV–BT, superficie con coating | 4,00 | 1,26 | 1,87 | 4,00 | IPC A5 · IEC PD_coat × factor de aislamiento |
| HV–HV, superficie con coating | 2,00 | 1,26 | 1,87 | 2,00 | IPC A5 · IEC PD_coat, básico |
| HV–HV, capas internas | 2,00 | 0,62 | — | 2,00 | IPC B1 (la línea de fuga no aplica en capas internas) |
| HV–HV, terminales sin recubrir | 2,00 | 1,96 | 3,29 | 3,29 | IPC A6 · IEC PD_bare, básico |
...
| Tensión de trabajo de la barrera: ADuM4146 (gate driver) (AIS-V-ADUM4146) | 2150 | V | 650 | CUMPLE |  |  |
| Línea de fuga del encapsulado: AMC1302 (amplificador aislado) (AIS-F-AMC1302) | 8,5 | mm | 4,0 | CUMPLE |  | TI: ≥ 8,5 mm; VIORM 2121 V pico |
| Tensión de trabajo de la barrera: AMC1302 (amplificador aislado) (AIS-V-AMC1302) | 2121 | V | 650 | CUMPLE |  |  |
| Línea de fuga del encapsulado: AMC1306 (modulador ΔΣ aislado) (AIS-F-AMC1306) | 8,5 | mm | 4,0 | CUMPLE |  | TI: ≥ 8,5 mm; VIORM 2120 V pico |
| Tensión de trabajo de la barrera: AMC1306 (modulador ΔΣ aislado) (AIS-V-AMC1306) | 2120 | V | 650 | CUMPLE |  |  |
...
| Tensión de trabajo de la barrera: MGJ2D052005BSC (fuente aislada de puerta) (AIS-V-MGJ2) | 2400 | V | 650 | CUMPLE |  |  |
...
| Fondo de escala frente a Ipk con margen (SEN-01) | 100,0 | A | 66,0 | CUMPLE | `I_FS ≥ I_margin·Ipk` |  |
| Corriente de recorte (AMC1302) | 128,0 | A |  |  | `Sa_Vclip/R_shunt` |  |
| Tensión en el shunt a Ipk | 27,5 | mV |  |  | `Ipk·R_shunt` |  |
| Umbral de sobrecorriente por encima de Ipk (SEN-02) | 90 | A | 55 | CUMPLE | `I_OC ≥ Ipk` |  |
...
| Magnitud | Valor | Unidad | Expresión | Nota |
|---|---|---|---|---|
| Tensión diferencial de salida a Ipk | 1,127 | V | `Ipk·R_shunt·Sa_G` |  |
| Resolución (LSB) con el ADC | 48,8 | mA | `2·I_FS/2^N_adc` |  |
| Retardo de la cadena / semiperiodo de PWM | 18,0 | % | `Sa_td·2·fsw` |  |
...
| Muestras por periodo de PWM | 5,21 | – |  |  | `f_clk_ds/(OSR·fsw)` |  |
...
| Tiempo de establecimiento del filtro frente al semiperiodo de PWM (SEN-05) | 19,2 | µs | 16,7 | **REVISAR** | `N_sinc·OSR/f_clk_ds ≤ 1/(2·fsw)` | Una muestra independiente por semiperiodo (muestreo sincronizado) |
...
| Corriente del divisor a V_cont | 243 | µA |  |  | `V_cont/(R_top + R_bot_eff)` |  |
| Potencia en cada resistencia superior a V_cont (SEN-06) | 39,4 | mW | 125,0 | CUMPLE | `I_div²·R_top/N_res ≤ k_res·P_res_rat` |  |
| Tensión en cada resistencia superior en el caso de fallo (SEN-07) | 174 | V | 200 | CUMPLE | `V_fault_max·R_top/(R_top + R_bot_eff)/N_res ≤ V_res_rat` |  |
| Fondo de escala de Vbus frente a la tensión de fallo (SEN-08) | 700 | V | 694 | CUMPLE | `V_meas_FS ≥ V_fault_max` |  |
| Tensión en el sensor a Vbus_max | 144,6 | mV |  |  | `Vbus_max·R_bot_eff/(R_top + R_bot_eff)` |  |
...
| Umbral de sobretensión por encima de Vbus_max (SEN-09) | 420 | V | 405 | CUMPLE | `V_OV ≥ Vbus_max` |  |
| Umbral de sobretensión por debajo de V_cont (SEN-10) | 420 | V | 650 | CUMPLE | `V_OV ≤ V_cont` |  |
| Tensión en el sensor en el umbral de sobretensión | 150,0 | mV |  |  | `V_OV·R_bot_eff/(R_top + R_bot_eff)` |  |
...
| Potencia de puerta | 0,104 | W |  |  | `Qg·dVg·fsw` | Qg medida con la excursión de la hoja de datos: aproximación |
| Potencia en la salida de la fuente aislada | 0,266 | W |  |  | `P_gate + D_IDD2·dVg` |  |
| Carga de la fuente aislada frente a su potencia nominal (GDR-04) | 0,266 | W | 2,000 | CUMPLE | `P_iso_out ≤ G_P` |  |
| Corriente media de la salida +20 V (GDR-05) | 10,6 | mA | 80,0 | CUMPLE | `Qg·fsw + D_IDD2 ≤ G_Ipos` |  |
| Corriente media de la salida −5 V (GDR-06) | 10,6 | mA | 40,0 | CUMPLE | `Qg·fsw + D_IDD2 ≤ G_Ineg` | Supone que toda la corriente de VDD2 vuelve por −5 V (conservador) |
| Potencia de entrada de cada fuente aislada | 0,359 | W |  |  | `P_iso_out/G_eta` |  |
| Corriente de entrada de cada fuente aislada | 71,9 | mA |  |  | `P_iso_in/G_Vin` | Se usa en el consumo de BT |

### 8.3 Corrientes de pico, dv/dt y Miller

| Magnitud | Valor | Unidad | Límite | Resultado | Expresión | Nota |
|---|---|---|---|---|---|---|
| Corriente de pico de encendido (GDR-07) | 2,32 | A | 11,00 | CUMPLE | `dVg/(Rg_on + Rgint + D_Rp) ≤ D_Isrc` | Límite: corriente de cortocircuito del driver |
| Corriente de pico de apagado (GDR-08) | 2,36 | A | 9,00 | CUMPLE | `dVg/(Rg_off + Rgint + D_Rn) ≤ D_Isnk` |  |
| Constante de tiempo de encendido | 38,0 | ns |  |  | `(Rg_on + Rgint)·Ciss` |  |
| dv/dt estimada | 8,6 | kV/µs |  |  | `Vbus_max/tr` | tr de la hoja de datos con su RG de ensayo: recalcular con la RG real |
| dv/dt frente a la CMTI del driver (GDR-09) | 8,6 | kV/µs | 100,0 | CUMPLE | `dvdt ≤ CMTI` |  |
| dv/dt frente a la CMTI de los sensores aislados (GDR-10) | 8,6 | kV/µs | 100,0 | CUMPLE | `dvdt ≤ CMTI` |  |
| dv/dt frente a la CMTI de la fuente aislada (GDR-11) | 8,6 | kV/µs | 200,0 | CUMPLE | `dvdt ≤ CMTI` |  |
| Corriente de Miller | 0,172 | A |  |  | `Crss·dvdt` | Crss a 600 V; a VDS baja es mayor |
| Pico de VGS en OFF por efecto Miller (GDR-12) | −4,22 | V | 1,80 | CUMPLE | `Vgs_off + I_miller·(D_Rclamp + Rgint) ≤ Vth_min` | Con el Miller clamp activo |
...
| Fuentes aisladas de puerta (entrada a 5 V) | 5,0 | 71,89 | 4 | 1,438 | 85 | 1,990 | AC |
| Lógica cableada y comparadores | 3,3 | 10,00 | 1 | 0,033 | 85 | 0,046 | TBD |
| LEDs | 3,3 | 2,00 | 4 | 0,026 | 85 | 0,037 | TBD |

| Magnitud | Valor | Unidad | Límite | Resultado | Expresión | Nota |
|---|---|---|---|---|---|---|
| Subtotal desde BT | 3,40 | W |  |  | `Σ P desde BT` |  |
| Total por placa con margen | 4,09 | W |  |  | `P_BT_sub·(1 + P_margin)` | Se suma a las pérdidas en el balance térmico |
| Corriente de entrada a V_BT_min | 0,227 | A |  |  | `P_BT_total/V_BT_min` |  |
| Corriente de entrada a V_BT_max | 0,170 | A |  |  | `P_BT_total/V_BT_max` |  |
| Consumo de las N_MD placas | 40,9 | W |  |  | `N_MD·P_BT_total` | Dato para ME-I-02 |
| Consumo por placa frente al permitido (BT-01) | 4,09 | W | 15,00 | CUMPLE | `P_BT_total ≤ P_BT_lim` |  |
| EtherCAT P: corriente de la línea completa (BT-02) | 1,70 | A | 3,00 | CUMPLE | `N_MD·P_BT_total/ECP_V ≤ ECP_Imax` | Solo si se elige EtherCAT P: la primera conexión alimenta a todas las placas |
...
| POT-05 | Tensión de fallo frente a la tensión nominal del DC-link | 1. Potencia y bus DC | 694 | 650 | V | **NO CUMPLE** | DCB-08 | HW-02, HW-03 |  |
| POT-06 | Tensión de fallo frente a la VDS del MOSFET seleccionado | 1. Potencia y bus DC | 694 | 900 | V | CUMPLE | PWR-02 | HW-02 |  |
...
| GDR-04 | Carga de la fuente aislada frente a su potencia nominal | 8. Gate driving | 0,266 | 2,000 | W | CUMPLE | GD-01 · AUX-02 | HW-02 |  |
| GDR-05 | Corriente media de la salida +20 V | 8. Gate driving | 10,6 | 80,0 | mA | CUMPLE | GD-01 | HW-02 |  |
| GDR-06 | Corriente media de la salida −5 V | 8. Gate driving | 10,6 | 40,0 | mA | CUMPLE | GD-01 | HW-02 | Supone que toda la corriente de VDD2 vuelve por −5 V (conservador) |
| GDR-07 | Corriente de pico de encendido | 8. Gate driving | 2,32 | 11,00 | A | CUMPLE | GD-01 | HW-02 | Límite: corriente de cortocircuito del driver |
| GDR-08 | Corriente de pico de apagado | 8. Gate driving | 2,36 | 9,00 | A | CUMPLE | GD-01 | HW-02 |  |
| GDR-09 | dv/dt frente a la CMTI del driver | 8. Gate driving | 8,6 | 100,0 | kV/µs | CUMPLE | GD-01 | HW-02 |  |
...
| BT-01 | Consumo por placa frente al permitido | 9. Alimentación auxiliar (BT) | 4,09 | 15,00 | W | CUMPLE | AUX-03 | ME-I-02, HW-05 |  |
| BT-02 | EtherCAT P: corriente de la línea completa | 9. Alimentación auxiliar (BT) | 1,70 | 3,00 | A | CUMPLE | AUX-01 | ME-I-02 | Solo si se elige EtherCAT P: la primera conexión alimenta a todas las placas |
...
| AIS-V-AMC1302 | Tensión de trabajo de la barrera: AMC1302 (amplificador aislado) | 5. Aislamiento | 2121 | 650 | V | CUMPLE | ISO-06 |  |  |
...
| AIS-V-AMC1306 | Tensión de trabajo de la barrera: AMC1306 (modulador ΔΣ aislado) | 5. Aislamiento | 2120 | 650 | V | CUMPLE | ISO-06 |  |  |
...
| AIS-V-MGJ2 | Tensión de trabajo de la barrera: MGJ2D052005BSC (fuente aislada de puerta) | 5. Aislamiento | 2400 | 650 | V | CUMPLE | ISO-06 |  |  |
...
| SEN-01 | Fondo de escala frente a Ipk con margen | 7. Sensado y adquisición | 100,0 | 66,0 | A | CUMPLE | SNS-01 | HW-02 |  |
| SEN-02 | Umbral de sobrecorriente por encima de Ipk | 7. Sensado y adquisición | 90 | 55 | A | CUMPLE | SAF-04 | HW-01 |  |
...
| SEN-05 | Tiempo de establecimiento del filtro frente al semiperiodo de PWM | 7. Sensado y adquisición | 19,2 | 16,7 | µs | **REVISAR** | SNS-05 · SNS-06 | FW-01 | Una muestra independiente por semiperiodo (muestreo sincronizado) |
| SEN-06 | Potencia en cada resistencia superior a V_cont | 7. Sensado y adquisición | 39,4 | 125,0 | mW | CUMPLE | SNS-02 | HW-02 |  |
| SEN-07 | Tensión en cada resistencia superior en el caso de fallo | 7. Sensado y adquisición | 174 | 200 | V | CUMPLE | DCB-02 · SNS-02 | HW-02, HW-03 |  |
| SEN-08 | Fondo de escala de Vbus frente a la tensión de fallo | 7. Sensado y adquisición | 700 | 694 | V | CUMPLE | SNS-02 · DCB-08 | HW-03 |  |
| SEN-09 | Umbral de sobretensión por encima de Vbus_max | 7. Sensado y adquisición | 420 | 405 | V | CUMPLE | SAF-01 | HW-01 |  |
| SEN-10 | Umbral de sobretensión por debajo de V_cont | 7. Sensado y adquisición | 420 | 650 | V | CUMPLE | SAF-01 · DCB-02 | HW-01 |  |
...
| TBD | `Rg_on` | Resistencia de puerta externa de encendido | 8 Ω | HW-02 |
| TBD | `Rg_off` | Resistencia de puerta externa de apagado | 8 Ω | HW-02 |
...
| TBD | `I_OC` | Umbral de sobrecorriente por hardware | 90 A | SAF-04 · HW-01 |
...
| TBD | `V_OV` | Umbral de sobretensión de bus por hardware | 420 V | SAF-01 · HW-01 |
...
| AC | `dVdc_pct` | Rizado máximo de tensión en el DC-link (fracción de Vbus_min) | 1 % | DCB-07 · HW-02 |
...
| AC | `V_film` | Tensión nominal de los condensadores del DC-link | 650 V | DCB-02 · HW-02 |
